...
# GeoDCAT profile of STAC TASL extension (Schema)

`ogc.profiles.cc.stac.extensions.geodcat-stac-tasl` *v0.1*

Defines a STAC extension for implementing the TASL profile
...
* Path: `_sources/stac/extensions/geodcat-stac-tasl`
